...
def main():
    ...
    src_folder_name = '/home/bell-chuangxingang/下载/data'#KFB文件所在文件夹
    des_folder_name = '/home/bell-chuangxingang/下载/svs'       #保存SVS文件的文件夹
    level = 9
    # argvs = sys.argv
    # if len(argvs) != 4:
    #     raise AttributeError('Example: convert_kfb2svs.py [src_folder_name] [des_folder_name] [level]')

    exe_path = "/home/bell-chuangxingang/下载/kfb2svs/x86/KFbioConverter.exe" #下载的转换程序所在文件夹
