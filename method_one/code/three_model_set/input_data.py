...
# -----------------生成图片路径和标签的List------------------------------------
train_dir = '/home/bell-156/桌面/inceptionV3/data_prepare/pic/train'
...
def get_files(file_dir, ratio):
    ...
    image_list = np.hstack((yang, ying))
    label_list = np.hstack((label_yang, label_ying))
...
#     a,b,c, d = get_files(train_dir, 0.3)
#     e,f = get_batch(a, b, 64, 64, 32, 200)