...
def build_model():
    ...
    model.load_weights('/home/bell-chuangxingang/Data/HIE/DL4ETI-realcode/HIENet/final/2-weights.27-0.9986-0.0150-0.9741.h5')
    model.summary()
    return model
...
if __name__ == '__main__':
    ...
    gradcam, gb, guided_gradcam = compute_saliency(model, guided_model, layer_name='dense_8',
                                             img_path='/home/bell-chuangxingang/Data/HIE/数据集/恶性肿瘤细胞/11C_3_4.jpg', cls=3, visualize=True, save=True)
